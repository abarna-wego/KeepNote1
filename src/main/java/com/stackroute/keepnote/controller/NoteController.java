...
public class NoteController {
	...
	@RequestMapping("/")
	public String GetallNotehandler()
	{
		List<Note> allList=new ArrayList<Note>();
		allList=noterepository.getAllNotes();
		ModelMap mmp=new ModelMap();
		mmp.addAttribute("notes",allList);
		return "index";
	}
	...
	*/
	...
	public String addNotesHandler(@RequestParam Integer noteId,@RequestParam String noteTitle,@RequestParam String noteContent,@RequestParam String noteStatus)
	{
		Note savedNote=(Note) context.getBean("note");
		savedNote.setNoteId(noteId);
		savedNote.setNoteTitle(noteTitle);
		savedNote.setNoteContent(noteContent);
		savedNote.setNoteStatus(noteStatus);
		savedNote.setCreatedAt(LocalDateTime.now());
		noterepository.addNote(savedNote);
		return "index";
	}
	...
	*/
	...
	public String deleteNoteHandler(@RequestParam Integer noteId)
	{
